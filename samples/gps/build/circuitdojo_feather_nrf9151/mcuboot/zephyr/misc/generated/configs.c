...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CIRCUITDOJO_FEATHER_NRF9151_NRF9151, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MFD_LOG_LEVEL, 0);
