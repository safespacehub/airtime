...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_SUPL_HOSTNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_SUPL_PORT, 7276);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLIGHT_TIMER_LOG_BACKEND_SD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_BOSCH_BMP581_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_PCF8523_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_NFED_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_METAIRQ_PRIORITIES, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_WORKQUEUE_STACK_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SUPL_CLIENT_LIB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HW_ID_LIBRARY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HW_ID_LIBRARY_SOURCE_DEVICE_ID, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CIRCUITDOJO_FEATHER_NRF9151, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CIRCUITDOJO_FEATHER_NRF9151_NRF9151_NS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CIRCUITDOJO_FEATHER_NRF9151_STATIC_PARTITIONS_FACTORY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CIRCUITDOJO_FEATHER_NRF9151_PMIC_STARTUP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RTC_PCF8523, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BMP581, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_TIMESTAMP_USE_REALTIME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_OUTPUT_FORMAT_DATE_TIMESTAMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_OUTPUT_TEXT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_OUTPUT_DEFAULT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_AUTOSTART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_OVERWRITE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_APPEND_TO_NEWEST_FILE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_FILE_PREFIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_DIR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_FILE_SIZE, 1048576);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_FILES_LIMIT, 400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SD_INIT_TIMEOUT, 1000);
